...
class _ThemeChallengePanelState extends State<ThemeChallengePanel> {
  // could not figure out how to get the theme to display its contents but we customized it
  ...
  Widget build(BuildContext context) {
    return Container(
      color: arcanePower >= mana ? Colors.green.shade100 : Colors.white,
      child: Column(
        children: [
          Text('Score: $mana | Actions: $spellsCast'),
          if (arcanePower >= mana) const Text('Arcane Power!'),
          ElevatedButton(
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      const Text("Magic Spell Console", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.blueAccent)),
            ...
            Wrap(
              ...
              children: [
                TactileButton(
                  ...
                  onPressed: () => _triggerAction("Casted Fireball"),
                ),
                TactileButton(
                  icon: Icons.shield,
                  label: "SHIELD",
                  ...
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("Defense Shield Activated"),
                ),
                TactileButton(
                  ...
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("Teleported to Safe Zone"),
                ),
                TactileButton(
                  ...
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("Casted Heal"),
                ),
              ],
            ),
